...
public class IcmpV4DestUnreachablePacketUDF extends UDF {
    private IcmpV4DestinationUnreachablePacket packet;

    // TODO - Format output
    public Text evaluate(BytesWritable bytes) {
        try {
            packet = IcmpV4DestinationUnreachablePacket.newPacket(bytes.getBytes(),
                    0, bytes.getLength());
