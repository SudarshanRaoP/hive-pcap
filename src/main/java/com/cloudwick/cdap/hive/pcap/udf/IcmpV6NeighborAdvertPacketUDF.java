...
public class IcmpV6NeighborAdvertPacketUDF extends UDF {
        private IcmpV6NeighborAdvertisementPacket packet;

        // TODO - Format output
        public Text evaluate(BytesWritable bytes) {
            try {
                packet = IcmpV6NeighborAdvertisementPacket.newPacket(bytes.getBytes(),
                        0, bytes.getLength());
